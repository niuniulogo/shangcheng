<template>
	...
	<div class="container">
		<div id="wrapper" class="m_pwd">
			<!--<h2 class="int_title clearfix"><span class="int_pic"><img src="static/images/jifen/left.png"/></span>积分商城</h2>-->
			<div class="int_title"><span class="int_pic" @click="btn"><img src="static/images/jifen/left.png"/></span>订单详情</div>
					...
					<ul class="fill_box">
						<li class="fill_left fill_list fl">
							...
							<p class="fill_pic clearfix">
								<span class="span_pic fl"><img src="static/images/ddxq/icon.png"></span>
								<span class="span_text fr">北京市丰台区北京市丰台区北京市丰台区北京市丰台区北京市丰台区</span>
							</p>
						</li>
						<li class="fill_right fill_list fr">
							<img src="static/images/ddxq/right.png" class="fill_img" />
						</li>
					</ul>
				</div>
			<!--banner start-->	
			<div class="order">
				...
				<dl class="order_box topline clearfix">
					<dt class="order_pic fl">
						<img src="static/images/ddxq/img.png" />
					</dt>
			...
			<div class="payment">
				...
				<p class="p_content topline">
					<span class="p_c_txt">支付方式：万福卡支付</span>
					<span class="p_c_txt">下单时间：2016-05-28   14:28</span>
					<span class="p_c_txt">发货时间：2016-05-28   14:28</span>
					<span class="p_c_txt">支付积分：406</span>
				</p>
			</div>
			</div>
